...
<body>
  <div class="app">
    <div class="hdr">
      ...
      <div class="tabs">
        <button type="button" class="tab on" id="tabSell">🛒 የገበያ ቦታ</button>
  ...
  (function () {
    ...
    try {
      if (location && location.origin && location.origin.indexOf("adika") !== -1) {
    ...
    var I18N = {
      am: {
        sell: "🛒 የገበያ ቦታ", buy: "📋 የፈላጊዎች", search: "ፈልግ...",
    ...
    langAM.onclick = function () { lang = "am"; localStorage.setItem("adika_lang", lang); applyLang(); load(false); };
    langEN.onclick = function () { lang = "en"; localStorage.setItem("adika_lang", lang); applyLang(); load(false); };
    ...
    applyLang();
    setTimeout(function () { load(false); }, 40);
  })();
  </script>
</body>
</html>
