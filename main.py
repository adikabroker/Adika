...
def main():
    ...
    broker_conv = ConversationHandler(
        ...
        states={
            ...
            BROKER_FAYDA: [
                ...
                MessageHandler(filters.Document.IMAGE, broker_reg_fayda),
                MessageHandler(filters.Document.ALL, broker_reg_fayda),
    ...
    app.add_handler(CallbackQueryHandler(text_mode_callback, pattern=r"^(view_text_|text_mode_|tm_sold_|tm_call_)"))
