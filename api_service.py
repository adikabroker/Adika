...
# ==============================================================================
# OpenRouter / Qwen 2.5 32B Senior Financial Advisor AI Service
# ==============================================================================
OPENROUTER_BASE_URL = "https://openrouter.ai/api/v1/chat/completions"
OPENROUTER_ADVISOR_MODEL = os.environ.get("OPENROUTER_MODEL") or "qwen/qwen-2.5-32b-instruct"

SYSTEM_PROMPT = """You are Adika's Senior Financial Advisor in Ethiopia.

STRICT BEHAVIOR RULES:
1. LANGUAGE: Respond EXCLUSIVELY in clear, executive-level Amharic (ንጹህ እና ተፈጥሮአዊ አማርኛ). Never output foreign scripts (Korean, Hebrew, Russian) or English phrases inside sentences.
2. NO RAW MARKDOWN: Do NOT output formatting symbols like **, *, or ###. Provide clean text with simple numbered lists (1, 2, 3) where necessary.
