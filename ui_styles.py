...
EXPLORER_CSS = r"""
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    #aiToolsView .tools-ambient-blob { position: absolute; pointer-events: none; }
    #hubFinanceAdvisorBanner {
    ...
    #opportunityCards { position: relative; z-index: 2; }
    .tools-grid-compact { position: relative; z-index: 1; flex: 0 0 auto !important; height: auto !important; }
